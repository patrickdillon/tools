...
plugin_path=/home/padillon/go/src/github.com/patrickdillon/openshift-installer-gcp-plugin/openshift-installer-gcp-plugin.so
dir_suffix=ash
...
podman run --rm -it                                              \
    ...
    -v "${plugin_path}":/openshift-installer-gcp-plugin.so:z                              \
    ...
    -e OPENSHIFT_INSTALL_PLUGIN_PATH="openshift-installer-gcp-plugin.so" \
